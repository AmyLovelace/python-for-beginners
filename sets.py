...
while user_input != "salir":
    ...
    lista_de_dias = user_input.split(", ")
    print(lista_de_dias)
    print (set(lista_de_dias))

    print(type(lista_de_dias))
    print(type(set(lista_de_dias)))
    
    for num_de_dias_elemento in set(lista_de_dias):
        validar_y_ejecutar()
